...
export function CTA() {
  ...
  const submit = (e: FormEvent) => {
    ...
    window.location.href = `mailto:eu-access@surstor.eu?subject=${encodeURIComponent('SurStor EU access request')}${addr ? `&body=${encodeURIComponent(`Work email: ${addr}\n\nWe'd like to discuss Article 12 record-keeping for our AI systems.`)}` : ''}`
  }
  ...
  return (
    <section id="contact" className="hairline-t noise relative overflow-hidden py-28 sm:py-36">
      ...
      <div
        ...
        style={{ background: 'radial-gradient(closest-side, rgba(255,158,64,0.1), transparent)' }}
      />
        ...
        <div className="grid gap-12 md:grid-cols-[1.2fr_repeat(3,0.7fr)]">
          <div>
            <div className="flex items-baseline gap-2">
              <span className="font-display text-2xl font-bold tracking-tight">SurStor</span>
